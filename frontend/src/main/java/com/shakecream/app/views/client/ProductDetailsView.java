...
public class ProductDetailsView {
        ...
        private void renderizarTela(Stage stage, String nomeProduto, double precoBase, String pathImagem,
                ...
                lbDescricao.setStyle("-fx-font-family: 'Montserrat'; -fx-font-size: 15; -fx-text-fill: "
                                + COLOR_TEXT_MUTED + ";");
                ...
                if (!ehBebida) {
                        ...
                        lbTituloTamanho.setStyle(
                                        "-fx-font-family: 'Montserrat'; -fx-font-size: 13; -fx-font-weight: bold; -fx-text-fill: "
                                                        + COLOR_TEXT_MUTED + ";");
